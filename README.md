...
**Demo video:** `[add your Loom / YouTube / Drive link here after recording]`

**Business write-up:** [`docs/business-writeup.docx`](docs/business-writeup.docx)
**Architecture diagram:** [`docs/architecture-diagram.svg`](docs/architecture-diagram.svg) · [PNG](docs/architecture-diagram.png)

---

## Deliverables checklist

| Required by the assignment | Where it is |
|---|---|
| Working solution, runnable locally | `src/` — see Quick start below |
| README: setup, architecture, which Sarvam APIs and why | This file |
| Demo video (3–5 min) | ⬜ **add link above once recorded** |
| Architecture diagram | `docs/architecture-diagram.svg` |
| Business write-up (1–2 pages) | `docs/business-writeup.docx` |
| Multilingual (≥2 languages) | Hindi + Marathi, `src/scripts.py` |
| Uses Sarvam APIs meaningfully | Saaras STT + Sarvam-105B + Bulbul TTS, all load-bearing |
| *Optional:* agentic workflow (event → tool call → downstream update) | `src/crm.py` — see `/crm` dashboard |
| *Optional:* telephony | Not built — see "Known limitations" for the honest reason and the swap-in path |
